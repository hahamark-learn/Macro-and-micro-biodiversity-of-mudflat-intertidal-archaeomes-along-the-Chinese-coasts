...
wd="C:\\Users/DELL/Desktop/raw-data/"
...
asv_Flattening = as.data.frame(t(rrarefy(t(), min(colSums(asv)))))
...
write.csv(icbin$Ptk,file = paste0(prefix,".ProcessImportance_EachBin_EachGroup-2.csv"),row.names = FALSE)
